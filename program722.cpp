...
// Maximum number of file we can open       
# define MAXOPENEDFILES 20 

// Maximum number of file we can create     
# define MAXINODE 5                
...
void DisplayHelp()
{
    ...
    printf("man : It is used to Display the manual page of the command\n");
    ...
    printf("ls : It is used to display all files \n");
    printf("stat : It is used to display information about file\n");
            ...
            )
{
    ...
    printf("Current Inodes reamaining : %d\n",superobj.FreeInodes);
    // Filters
...
//  Description :       It is used to Display the information about given file
//  Input :             File name
//  Output :            nothing
//  Author :            Piyush Manohar Khairnar
//  Date :              15/08/2025
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            else if(strcmp(Command[0], "stat") == 0)
            {
                ...
                {
                    printf("Unlink operation succesully performed\n");
                }
