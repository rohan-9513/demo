            ...
            )
{
    ...
    // Unable to write there is no sufficient space
        ...
        )
{
    ...
    strcpy(data, uareaobj.UFDT[fd]->ptrinode->Buffer + uareaobj.UFDT[fd]->ReadOffset, size);
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            {   
                ...
                {
                    printf("Error : Insufficient size in in the data blockof the file \n");
                }
        ...
        else if(iCount == 3)
        {
            ...
            else if(strcmp(Command[0], "read") == 0)
            {
                ...
                {
                    printf("Error : Insufficient Data in the data blockof the file \n");
                }
                else if(iRet = ERR_PERMISSION_DENIED)
                {
                    printf("error : permission denied \n");
